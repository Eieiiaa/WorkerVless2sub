...
// 设置优选地址api接口
let addressesapi = [
	'https://cf-workers-text2kv-4rw.pages.dev/ip.txt?token=joanna11', //可参考内容格式 自行搭建。
...
let DLS = 8;//速度下限
let addressescsv = [
	//'https://cf-workers-text2kv-4rw.pages.dev/result.csv?token=joanna11', //iptest测速结果文件。
];
